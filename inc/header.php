            ...
            <div class="memberNav">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php"><img style="max-width:100px; margin: 0px; padding: 0px; margin-top: -10px; margin-left: -25px; margin-right:10px;" src="img/whiteAppDevLogo.png"> Grinnell AppDev</a>
                    </div>
