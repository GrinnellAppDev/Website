...
*/
	...
	$("#devs").click( function() {
		...
		if (($(".jobRole").is(':empty')) || (desi == false)) { 
			$(".jobRole").append("<h3 class='redTitle'> UX/Graphic Designer </h3> <p> We are looking for designers to help us build beautiful apps and craft captivating user experiences. We want users to easily and intuitively utilize our apps to their maximum potential. We want our apps to be useful, exciting, rich, self-evident, and simultaneously subtle, and we need your help!</p> <p>We’re looking for people with previous experience in visual design and a familiarity with graphic design software (i.e Adobe CS6, GIMP, Corel, Sketch…), who knows what ‘svg’ stands for and does not back down from a creative challenge. Our designers will participate in all aspects of the product development process and collaborate closely with the Product and Engineering Teams throughout the entire project lifecycle. </p> <p><em>What we’re looking for:</em><ul><li>great sense of design</li> <li>experience with graphic design software</li><li>interest in human computer interaction</li><li>passion for learning </li></ul></p> <p><em>What we’re offering:</em><ul><li>$5K+ in educational resources available in both design and development</li><li>access to professional graphic design software</li><li>a chance to work on tangible projects</li><li>an awesome bullet point for your resume</li><li>a supportive community</li></ul></p><h3 class='redTitle'> User Experience Researcher </h3><p> We’re looking for a User Experience Researcher be in charge of planning, coordinating, and executing usability research studies. You will be responsible for designing, analyzing user-centered design research, identifying user needs and goals, creating workflows and developing personas for our applications to better serve the community. We're looking for someone who's curious, creative and has a knack for understanding their audience. You know how to identify what our users need, what they want, how they think, and how they interact. You will work closely with both the designers and developers to produce quality apps that will benefit Grinnell College.</p><p><em>What we're looking for:</em><ul><li>conduct independent research on multiple aspects of the user experience</li><li>collect and analyze user behavior through A/B testings, surveys or lab studies</li><li>generate user personas, user scenarios, and conduct heuristic evaluations</li><li>develop prototypes and wireframes</li><li>someone to work with visual designers and developers to implement and deliver the final product</li><li>3-4 hours of work commitment per week</li></ul><p><em>What we're offering:</em><ul><li>the ability to learn on the job</li><li>valuable experience in the booming field of user research</li><li>an opportunity to put your skills to good use</li><li>the power to impact the most important decisions in our application development</li><li>an awesome bullet point for your resume</li><li>a supportive community</li></ul></p>");
		}
		else {
		$(".jobRole").empty();
		}
